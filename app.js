...
//function to create a div for each meal........
const createMealInfoDiv = (meal, mealInput) => {
        ...
        document.getElementById("pid").textContent = "Meal details is Loaded 😊";

}


//function to show the meal infomation.......
...
// function to search the meal entered by the user.......

const searchMeal = () =>{
    const mealInput = document.getElementById('meal-input').value;
    if(mealInput)
     document.getElementById("pid").innerHTML = "Meal detials is Loading....."
...
const showMealDetailsDiv = data => {
    ...
    //document.getElementById("pid").textContent = "Meal detials is Loaded 😊"
    document.getElementById("pid").textContent = "Meal details is Loaded 😊";
    console.log("hello at the end")
}
